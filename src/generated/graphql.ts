...
export type BondSeizedEvent_Filter = {
  ...
  destination?: Maybe<Scalars['Bytes']>;
  destination_not?: Maybe<Scalars['Bytes']>;
  destination_in?: Maybe<Array<Scalars['Bytes']>>;
  destination_not_in?: Maybe<Array<Scalars['Bytes']>>;
  destination_contains?: Maybe<Scalars['Bytes']>;
  destination_not_contains?: Maybe<Scalars['Bytes']>;
...
export type BondedEcdsaKeep = {
  ...
  stakedropRewardStatus?: Maybe<StakedropRewardStatus>;
...
export type BondedEcdsaKeep_Filter = {
  ...
  stakedropRewardStatus?: Maybe<StakedropRewardStatus>;
  stakedropRewardStatus_not?: Maybe<StakedropRewardStatus>;
...
export type Deposit = {
  ...
  randomBeaconFee: Scalars['BigInt'];
  /** The ratio of backing ETH to lot size. This allows you to sort by collateralization-ratio. */
  etcToBtcRatio: Scalars['BigInt'];
...
export type Deposit_Filter = {
  ...
  randomBeaconFee?: Maybe<Scalars['BigInt']>;
  randomBeaconFee_not?: Maybe<Scalars['BigInt']>;
  randomBeaconFee_gt?: Maybe<Scalars['BigInt']>;
  randomBeaconFee_lt?: Maybe<Scalars['BigInt']>;
  randomBeaconFee_gte?: Maybe<Scalars['BigInt']>;
  randomBeaconFee_lte?: Maybe<Scalars['BigInt']>;
  randomBeaconFee_in?: Maybe<Array<Scalars['BigInt']>>;
  randomBeaconFee_not_in?: Maybe<Array<Scalars['BigInt']>>;
  etcToBtcRatio?: Maybe<Scalars['BigInt']>;
  etcToBtcRatio_not?: Maybe<Scalars['BigInt']>;
  etcToBtcRatio_gt?: Maybe<Scalars['BigInt']>;
  etcToBtcRatio_lt?: Maybe<Scalars['BigInt']>;
...
export enum Deposit_OrderBy {
  ...
  RandomBeaconFee = 'randomBeaconFee',
  EtcToBtcRatio = 'etcToBtcRatio',
...
export type GrantOperatorsArgs = {
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<Operator_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
...
export type Grant_Filter = {
  ...
  operators?: Maybe<Array<Scalars['String']>>;
  operators_not?: Maybe<Array<Scalars['String']>>;
  operators_contains?: Maybe<Array<Scalars['String']>>;
  operators_not_contains?: Maybe<Array<Scalars['String']>>;
  isManaged?: Maybe<Scalars['Boolean']>;
  isManaged_not?: Maybe<Scalars['Boolean']>;
  isManaged_in?: Maybe<Array<Scalars['Boolean']>>;
  isManaged_not_in?: Maybe<Array<Scalars['Boolean']>>;
...
export type Operator = {
  ...
  grant?: Maybe<Grant>;
  _mostRecentBondSeizedEventId?: Maybe<Scalars['ID']>;
};
...
export type Operator_Filter = {
  ...
  tbtcFeesEarned?: Maybe<Scalars['BigInt']>;
  tbtcFeesEarned_not?: Maybe<Scalars['BigInt']>;
  tbtcFeesEarned_gt?: Maybe<Scalars['BigInt']>;
  tbtcFeesEarned_lt?: Maybe<Scalars['BigInt']>;
  tbtcFeesEarned_gte?: Maybe<Scalars['BigInt']>;
  tbtcFeesEarned_lte?: Maybe<Scalars['BigInt']>;
  tbtcFeesEarned_in?: Maybe<Array<Scalars['BigInt']>>;
  tbtcFeesEarned_not_in?: Maybe<Array<Scalars['BigInt']>>;
  ...
  stakedropRewardsDispensed?: Maybe<Scalars['BigInt']>;
  stakedropRewardsDispensed_not?: Maybe<Scalars['BigInt']>;
  stakedropRewardsDispensed_gt?: Maybe<Scalars['BigInt']>;
  stakedropRewardsDispensed_lt?: Maybe<Scalars['BigInt']>;
  stakedropRewardsDispensed_gte?: Maybe<Scalars['BigInt']>;
  stakedropRewardsDispensed_lte?: Maybe<Scalars['BigInt']>;
  stakedropRewardsDispensed_in?: Maybe<Array<Scalars['BigInt']>>;
  stakedropRewardsDispensed_not_in?: Maybe<Array<Scalars['BigInt']>>;
  stakedropECDSARewardsDispensed?: Maybe<Scalars['BigInt']>;
  stakedropECDSARewardsDispensed_not?: Maybe<Scalars['BigInt']>;
  stakedropECDSARewardsDispensed_gt?: Maybe<Scalars['BigInt']>;
  stakedropECDSARewardsDispensed_lt?: Maybe<Scalars['BigInt']>;
  stakedropECDSARewardsDispensed_gte?: Maybe<Scalars['BigInt']>;
  stakedropECDSARewardsDispensed_lte?: Maybe<Scalars['BigInt']>;
  stakedropECDSARewardsDispensed_in?: Maybe<Array<Scalars['BigInt']>>;
  stakedropECDSARewardsDispensed_not_in?: Maybe<Array<Scalars['BigInt']>>;
  stakedropBeaconRewardsDispensed?: Maybe<Scalars['BigInt']>;
  stakedropBeaconRewardsDispensed_not?: Maybe<Scalars['BigInt']>;
  stakedropBeaconRewardsDispensed_gt?: Maybe<Scalars['BigInt']>;
  stakedropBeaconRewardsDispensed_lt?: Maybe<Scalars['BigInt']>;
  stakedropBeaconRewardsDispensed_gte?: Maybe<Scalars['BigInt']>;
  ...
  grant_not?: Maybe<Scalars['String']>;
  grant_gt?: Maybe<Scalars['String']>;
  grant_lt?: Maybe<Scalars['String']>;
  grant_gte?: Maybe<Scalars['String']>;
  grant_lte?: Maybe<Scalars['String']>;
  grant_in?: Maybe<Array<Scalars['String']>>;
  grant_not_in?: Maybe<Array<Scalars['String']>>;
  grant_contains?: Maybe<Scalars['String']>;
  grant_not_contains?: Maybe<Scalars['String']>;
  grant_starts_with?: Maybe<Scalars['String']>;
  grant_not_starts_with?: Maybe<Scalars['String']>;
  grant_ends_with?: Maybe<Scalars['String']>;
  grant_not_ends_with?: Maybe<Scalars['String']>;
  _mostRecentBondSeizedEventId?: Maybe<Scalars['ID']>;
  _mostRecentBondSeizedEventId_not?: Maybe<Scalars['ID']>;
  _mostRecentBondSeizedEventId_gt?: Maybe<Scalars['ID']>;
  _mostRecentBondSeizedEventId_lt?: Maybe<Scalars['ID']>;
  _mostRecentBondSeizedEventId_gte?: Maybe<Scalars['ID']>;
  _mostRecentBondSeizedEventId_lte?: Maybe<Scalars['ID']>;
  _mostRecentBondSeizedEventId_in?: Maybe<Array<Scalars['ID']>>;
  _mostRecentBondSeizedEventId_not_in?: Maybe<Array<Scalars['ID']>>;
};
...
export enum Operator_OrderBy {
  ...
  Grant = 'grant',
  MostRecentBondSeizedEventId = '_mostRecentBondSeizedEventId'
}
...
export type StatsRecord = {
  ...
  tbtcFees: Scalars['BigInt'];
  /** The amount of fees, in Wei, that depositors have paid for opening a deposit. */
  randomBeaconFees: Scalars['BigInt'];
  totalStakedropBeaconRewards: Scalars['BigInt'];
  totalStakedropECDSARewards: Scalars['BigInt'];
  unallocatedStakedropBeaconRewards: Scalars['BigInt'];
  unallocatedStakedropECDSARewards: Scalars['BigInt'];
  dispensedStakedropBeaconRewards: Scalars['BigInt'];
  dispensedStakedropECDSARewards: Scalars['BigInt'];
};
...
export type StatsRecord_Filter = {
  ...
  numStakers?: Maybe<Scalars['Int']>;
  numStakers_not?: Maybe<Scalars['Int']>;
  numStakers_gt?: Maybe<Scalars['Int']>;
  numStakers_lt?: Maybe<Scalars['Int']>;
  numStakers_gte?: Maybe<Scalars['Int']>;
  numStakers_lte?: Maybe<Scalars['Int']>;
  numStakers_in?: Maybe<Array<Scalars['Int']>>;
  numStakers_not_in?: Maybe<Array<Scalars['Int']>>;
  ...
  tbtcFees?: Maybe<Scalars['BigInt']>;
  tbtcFees_not?: Maybe<Scalars['BigInt']>;
  tbtcFees_gt?: Maybe<Scalars['BigInt']>;
  tbtcFees_lt?: Maybe<Scalars['BigInt']>;
  tbtcFees_gte?: Maybe<Scalars['BigInt']>;
  tbtcFees_lte?: Maybe<Scalars['BigInt']>;
  tbtcFees_in?: Maybe<Array<Scalars['BigInt']>>;
  tbtcFees_not_in?: Maybe<Array<Scalars['BigInt']>>;
  randomBeaconFees?: Maybe<Scalars['BigInt']>;
  randomBeaconFees_not?: Maybe<Scalars['BigInt']>;
  randomBeaconFees_gt?: Maybe<Scalars['BigInt']>;
  randomBeaconFees_lt?: Maybe<Scalars['BigInt']>;
  randomBeaconFees_gte?: Maybe<Scalars['BigInt']>;
  randomBeaconFees_lte?: Maybe<Scalars['BigInt']>;
  randomBeaconFees_in?: Maybe<Array<Scalars['BigInt']>>;
  randomBeaconFees_not_in?: Maybe<Array<Scalars['BigInt']>>;
  totalStakedropBeaconRewards?: Maybe<Scalars['BigInt']>;
  totalStakedropBeaconRewards_not?: Maybe<Scalars['BigInt']>;
  totalStakedropBeaconRewards_gt?: Maybe<Scalars['BigInt']>;
  totalStakedropBeaconRewards_lt?: Maybe<Scalars['BigInt']>;
  totalStakedropBeaconRewards_gte?: Maybe<Scalars['BigInt']>;
  totalStakedropBeaconRewards_lte?: Maybe<Scalars['BigInt']>;
  totalStakedropBeaconRewards_in?: Maybe<Array<Scalars['BigInt']>>;
  totalStakedropBeaconRewards_not_in?: Maybe<Array<Scalars['BigInt']>>;
  totalStakedropECDSARewards?: Maybe<Scalars['BigInt']>;
  totalStakedropECDSARewards_not?: Maybe<Scalars['BigInt']>;
  totalStakedropECDSARewards_gt?: Maybe<Scalars['BigInt']>;
  totalStakedropECDSARewards_lt?: Maybe<Scalars['BigInt']>;
  totalStakedropECDSARewards_gte?: Maybe<Scalars['BigInt']>;
  totalStakedropECDSARewards_lte?: Maybe<Scalars['BigInt']>;
  totalStakedropECDSARewards_in?: Maybe<Array<Scalars['BigInt']>>;
  totalStakedropECDSARewards_not_in?: Maybe<Array<Scalars['BigInt']>>;
  unallocatedStakedropBeaconRewards?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropBeaconRewards_not?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropBeaconRewards_gt?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropBeaconRewards_lt?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropBeaconRewards_gte?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropBeaconRewards_lte?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropBeaconRewards_in?: Maybe<Array<Scalars['BigInt']>>;
  unallocatedStakedropBeaconRewards_not_in?: Maybe<Array<Scalars['BigInt']>>;
  unallocatedStakedropECDSARewards?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropECDSARewards_not?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropECDSARewards_gt?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropECDSARewards_lt?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropECDSARewards_gte?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropECDSARewards_lte?: Maybe<Scalars['BigInt']>;
  unallocatedStakedropECDSARewards_in?: Maybe<Array<Scalars['BigInt']>>;
  unallocatedStakedropECDSARewards_not_in?: Maybe<Array<Scalars['BigInt']>>;
  dispensedStakedropBeaconRewards?: Maybe<Scalars['BigInt']>;
  dispensedStakedropBeaconRewards_not?: Maybe<Scalars['BigInt']>;
  dispensedStakedropBeaconRewards_gt?: Maybe<Scalars['BigInt']>;
  dispensedStakedropBeaconRewards_lt?: Maybe<Scalars['BigInt']>;
  dispensedStakedropBeaconRewards_gte?: Maybe<Scalars['BigInt']>;
  dispensedStakedropBeaconRewards_lte?: Maybe<Scalars['BigInt']>;
  dispensedStakedropBeaconRewards_in?: Maybe<Array<Scalars['BigInt']>>;
  dispensedStakedropBeaconRewards_not_in?: Maybe<Array<Scalars['BigInt']>>;
  dispensedStakedropECDSARewards?: Maybe<Scalars['BigInt']>;
  dispensedStakedropECDSARewards_not?: Maybe<Scalars['BigInt']>;
  dispensedStakedropECDSARewards_gt?: Maybe<Scalars['BigInt']>;
  dispensedStakedropECDSARewards_lt?: Maybe<Scalars['BigInt']>;
  dispensedStakedropECDSARewards_gte?: Maybe<Scalars['BigInt']>;
  dispensedStakedropECDSARewards_lte?: Maybe<Scalars['BigInt']>;
  dispensedStakedropECDSARewards_in?: Maybe<Array<Scalars['BigInt']>>;
  dispensedStakedropECDSARewards_not_in?: Maybe<Array<Scalars['BigInt']>>;
};
...
export enum StatsRecord_OrderBy {
  ...
  TbtcFees = 'tbtcFees',
  RandomBeaconFees = 'randomBeaconFees',
  TotalStakedropBeaconRewards = 'totalStakedropBeaconRewards',
  TotalStakedropEcdsaRewards = 'totalStakedropECDSARewards',
  UnallocatedStakedropBeaconRewards = 'unallocatedStakedropBeaconRewards',
  UnallocatedStakedropEcdsaRewards = 'unallocatedStakedropECDSARewards',
  DispensedStakedropBeaconRewards = 'dispensedStakedropBeaconRewards',
  DispensedStakedropEcdsaRewards = 'dispensedStakedropECDSARewards'
}
...
export type GetDepositsQuery = (
  ...
  & { deposits: Array<(
    { __typename?: 'Deposit' }
    & Pick<Deposit, 'id' | 'contractAddress' | 'lotSizeSatoshis' | 'currentState' | 'keepAddress' | 'updatedAt' | 'createdAt' | 'redemptionStartedAt' | 'currentStateTimesOutAt' | 'creator' | 'lastActor' | 'finalBtcPrice' | 'undercollateralizedThresholdPercent' | 'severelyUndercollateralizedThresholdPercent'>
    & { tdtToken: (
      { __typename?: 'TBTCDepositToken' }
...
export type GetGrantsQuery = (
  ...
  & { grants: Array<(
    { __typename?: 'Grant' }
    & Pick<Grant, 'id' | 'grantee' | 'revokedAt' | 'revokedAmount' | 'revokedWithdrawn' | 'revocable' | 'amount' | 'duration' | 'timestamp' | 'start' | 'cliff' | 'withdrawn' | 'staked' | 'stakingPolicy' | 'transactionHash'>
  )> }
);
...
export type GetOperatorKeepsQuery = (
  ...
  & { operator?: Maybe<(
    ...
    & { keeps?: Maybe<Array<(
      { __typename?: 'BondedECDSAKeep' }
      & Pick<BondedEcdsaKeep, 'id' | 'totalBondAmount' | 'stakedropRewardStatus'>
      & { stakedropInterval?: Maybe<(
        { __typename?: 'StakedropInterval' }
        & Pick<StakedropInterval, 'number'>
      )>, deposit: (
        { __typename?: 'Deposit' }
        & Pick<Deposit, 'id' | 'contractAddress' | 'lotSizeSatoshis' | 'currentState' | 'keepAddress' | 'createdAt' | 'finalBtcPrice' | 'undercollateralizedThresholdPercent' | 'severelyUndercollateralizedThresholdPercent'>
        & { tdtToken: (
          { __typename?: 'TBTCDepositToken' }
          & Pick<TbtcDepositToken, 'owner'>
        ), bondedECDSAKeep?: Maybe<(
...
export type GetOperatorLogQuery = (
  ...
  & { events: Array<(
    ...
    { __typename: 'BondSeizedEvent' }
    & Pick<BondSeizedEvent, 'amount' | 'destination' | 'referenceId' | 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    { __typename: 'CourtesyCalledEvent' }
    & Pick<CourtesyCalledEvent, 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    ...
    { __typename: 'TokensSeizedEvent' }
    & Pick<TokensSeizedEvent, 'amount' | 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    { __typename: 'TokensSlashedEvent' }
    & Pick<TokensSlashedEvent, 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    { __typename: 'TopUpCompletedEvent' }
    & Pick<TopUpCompletedEvent, 'newAmount' | 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    { __typename: 'TopUpInitiatedEvent' }
    & Pick<TopUpInitiatedEvent, 'amount' | 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    { __typename: 'UnbondedValueDepositedEvent' }
    & Pick<UnbondedValueDepositedEvent, 'amount' | 'beneficiary' | 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    { __typename: 'UnbondedValueWithdrawnEvent' }
    & Pick<UnbondedValueWithdrawnEvent, 'amount' | 'beneficiary' | 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  ) | (
    { __typename: 'UndelegatedEvent' }
    & Pick<UndelegatedEvent, 'id' | 'transactionHash' | 'submitter' | 'timestamp'>
  )> }
...
export type GetOperatorDataQuery = (
  ...
  & { operator?: Maybe<(
    { __typename?: 'Operator' }
    & Pick<Operator, 'id' | 'address' | 'owner' | 'beneficiary' | 'authorizer' | 'stakedAmount' | 'ethLocked' | 'stakedAt' | 'stakeLockExpiresAt' | 'randomBeaconOperatorAuthorized' | 'bondedECDSAKeepFactoryAuthorized' | 'tbtcSystemSortitionPoolAuthorized' | 'stakedropEthScore' | 'stakedropBoost' | 'stakedropRewardWeight'>
  )>, status?: Maybe<(
    { __typename?: 'StatusRecord' }
...
export type GetOperatorQuery = (
  ...
  & { operator?: Maybe<(
    { __typename?: 'Operator' }
    & Pick<Operator, 'id' | 'address' | 'bonded' | 'unboundAvailable' | 'stakedAmount' | 'totalFaultCount' | 'attributableFaultCount' | 'totalTBTCRewards' | 'stakedropRewardsDispensed' | 'stakedropECDSARewardsDispensed' | 'stakedropBeaconRewardsDispensed'>
...
export const GetGrantsDocument = gql`
    query GetGrants($orderBy: Grant_orderBy, $direction: OrderDirection, $block: Block_height) {
...
export function useGetGrantsQuery(baseOptions?: Apollo.QueryHookOptions<GetGrantsQuery, GetGrantsQueryVariables>) {
        return Apollo.useQuery<GetGrantsQuery, GetGrantsQueryVariables>(GetGrantsDocument, baseOptions);
      }
export function useGetGrantsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetGrantsQuery, GetGrantsQueryVariables>) {
          return Apollo.useLazyQuery<GetGrantsQuery, GetGrantsQueryVariables>(GetGrantsDocument, baseOptions);
        }
